...
[data_path, plotHistograms, pSHGFitViewer, plotPolarHistogram, arrowPlot, uselassoROI, useSlider, thresh] = pSHGGUI(initialDir, defaultDir, defaultThreshold , 'transmission')
