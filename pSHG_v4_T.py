...
[data_path, plotHistograms, pSHGFitViewer, plotPolarHistogram, arrowPlot, usepolygonalROI, useSlider, thresh , polygonal_roi_image] = pSHGGUI(initialDir, defaultDir, defaultThreshold , 'transmission')
